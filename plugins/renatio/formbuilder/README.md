...
![OctoberCMS Backup Manager](https://octobercms.com/storage/app/uploads/public/637/dde/9a9/637dde9a9a1d4324788036.png)
...
If you need Spam protection for your forms I recommend to install following plugin: [Spam Protection Plugin](https://octobercms.com/plugin/renatio-spamprotection)
...
This field has extra options:

**max_size** - The maximum file size that can be uploaded in megabytes. Default to 5.

**file_types** - File extensions separated by commas (,) or star (*) to allow all types. Default to `*`.
...
**file_types** - File extensions separated by commas (,) or star (*) to allow all types. Default to `.gif,.jpg,.jpeg,.png`.

**image_width** - Image preview width in pixels. Default to 100.

**image_height** - Image preview height in pixels. Default to 100.

**image_mode** - Thumb mode for the preview, eg: exact, portrait, landscape, auto or crop.
